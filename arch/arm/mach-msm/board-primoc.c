...
static int config_primoc_camera_on_gpios(void)
{
...
static void config_primoc_camera_off_gpios(void)
{
...
struct msm_camera_device_platform_data camera_device_data = {
  .camera_gpio_on  = config_primoc_camera_on_gpios,
  .camera_gpio_off = config_primoc_camera_off_gpios,
...
#ifndef CONFIG_MSM_MULTIMEDA_USE_ION
